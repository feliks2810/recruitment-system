...
return new class extends Migration {
    ...
    {
Schema::table('candidates', function (Blueprint $table) {
    $table->string('psikotes_result')->nullable()->change();
    $table->string('hc_intv_status')->nullable()->change();
    $table->string('user_intv_status')->nullable()->change();
    $table->string('bod_intv_status')->nullable()->change();
    $table->string('offering_letter_status')->nullable()->change();
    $table->string('mcu_status')->nullable()->change();
    $table->string('hiring_status')->nullable()->change();
});
    }
};